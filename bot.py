...
class IchiBot(KikClientCallback):
    ...
    def on_chat_message_received(self, chat_message: IncomingChatMessage):
        ...
        if chat_message.body.lower() == prefix+"pass" and chat_message.from_jid in super:
            ...
            if name == user_owns_federation(chat_message.from_jid):
                ...
                self.client.send_chat_message(chat_message.from_jid, "Please make sure you spelled the federation name correctly, it's also case sensitive.")
            return
            ...
            if fed == False:
                ...
                msg = ("[Federation Stats]\n"
                       "Name: {}\n"
                       "Bans: {}\n"
                       "Groups: {}\n"
                       "Key: {}\n\n"
                       "Do NOT share your key with anyone!").format(fed[0], fed[3], fed[4], fed[2])
            ...
            self.client.send_chat_message(chat_message.from_jid, "Hello!\nSend '/help' for help\nYou can now add me to groups.")
        return
    ...
    def on_group_message_received(self, chat_message: chatting.IncomingGroupChatMessage):
        ...
        #COMMANDS
            ...
            elif chat_message.body.lower() == prefix+"delete welcome" or chat_message.body.lower() == prefix+"delete rules":
                if is_admin:
                    if get_welcome(chat_message.group_jid) != None:
                        delete_welcome(chat_message.group_jid)
        ...
        #OTHER FUNCTIONS
            ...
            if " >> " in chat_message.body and is_user_admin(chat_message.from_jid, chat_message.group_jid):
                ...
                if is_trigger(chat_message.group_jid ,tri[0].strip()) != False:
